...
router.get('/m1000r', (request, response, next) => {
    ...
    <body>
        ...
        <footer style=display: flex; flex-direction: row; justify-content: space-evenly; border-top: 2px solid;>
            <div>
                <h3>Navegación</h3>
                <ul>
                    <li><a href=./index.html>Inicio</a></li>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>A01709449</li>
                    <li><a href=mailto:A01709449@tec.mx>A01709449@tec.mx</a></li>
                </ul>
            </div>
        </footer>
    </body>
